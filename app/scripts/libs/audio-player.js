...
var AudioPlayer = (function() {
  var _stop_callback, _play_callback, player, _player_id = '__player_id__', _last_control;
  ...
  document.addEventListener('click', function(e) {
    ...
    if (!classList.contains('audio-control') || classList.contains('disabled')) {
      return;
    }
