...
var MASK_CLASS_NAME = '__dialog-mask', LOCK_CLASS_NAME = '__dialog-lock';

var undef, htmlElem = document.documentElement, dialogCount = 0, bodyElem = document.body;
...
function Dialog(selector, opts) {
  ...
  if (opts.closeOnMask === undef || opts.closeOnMask) {
    var type = 'click', handler = function(e) {
...
Dialog.prototype = {
  refresh: function() {
    ...
    var top = parseInt(compuStyle.height, 10) / 2, left = parseInt(compuStyle.width, 10) / 2;
